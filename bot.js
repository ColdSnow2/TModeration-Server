...
\`\`\`
        ...
        case 'avatar':
          msg.channel.send(msg.mentions.members.first().displayAvatarURL().toString().toString().toString().toString().toString().toString().toString().toString().toString().toString())
          break
